package com.cea.celibrary.image.MultiSelector.adapter;
...
import com.cea.celibrary.image.MultiSelector.SelectedDataConfig;
        ...
        void bindData(final Image data) {
            ...
            if (showSelectIndicator) {
                ...
                if (mSelectedImages.contains(data)) {
                    // 设置选中状态
//                    indicator.setBackgroundResource(R.drawable.btn_login_skip_pressed);
                    ...
                    if (!SelectedDataConfig.mSelected.containsKey(data.path)) {
                        ...
                        indicator.setText((mSelectedImages.lastIndexOf(data) + 1) + "");
                    } else {
                    	indicator.setText((mSelectedImages.lastIndexOf(data) + 1) + "");
                    }
                } else {
