...
public class BabushkaText extends TextView {
    ...
    /**
     * Use this method to add a { babushkatext.BabushkaText.Piece} to a BabushkaText.
     * Each { babushkatext.BabushkaText.Piece } is added sequentially, so the
    ...
    /**
     * Get a specific { babushkatext.BabushkaText.Piece} in position index.
     *
    ...
    /**
     * Call this method when you're done adding { babushkatext.BabushkaText.Piece}s
    ...
    */
     ...
     *
     * You create a Piece by using it's {  babushkatext.BabushkaText.Piece.Builder}
     *
     */
    public static class Piece {
         ...
         * {  babushkatext.BabushkaText.Piece.Builder}.
         *
         ...
         * displayed. After doing so, you MUST call {@code display()} for the changes to show up.
         *
         *  color of text (it is NOT android Color resources ID, use getResources().getColor(R.color.colorId) for it)
         */
